...
extension UIImageView {
    ...
    func rotateLeft() {
        ...
        let imageRotation: CABasicAnimation = CABasicAnimation.init(keyPath: "transform.rotation")
        
        imageRotation.fromValue = 0
        imageRotation.toValue = (180*Double.pi) / -180
        imageRotation.duration = 0.2
        imageRotation.repeatCount = 1
        imageRotation.isRemovedOnCompletion = false
        imageRotation.autoreverses = false
        imageRotation.fillMode = kCAFillModeForwards
        
        self.layer.add(imageRotation, forKey: "imageRotation")
    }
